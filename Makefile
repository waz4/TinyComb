...
run_tests: tests
	...
	@python3 ${SCRIPT_DIR}makeAndCheckCombinationsList.py $(TMP_DIR) correctCombinationsList.txt sequentialCombinationsList.txt idCombinationsList.txt
...
cuda: cuda_library
	...
	${NVCC} ${BUILD_DIR}cudaCoherence.o -L${BUILD_DIR} -ltinycomb -o ${BUILD_DIR}cudaCoherenceTest
